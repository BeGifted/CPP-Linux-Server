#ifndef __CHAT_HTTP2_HTTP2_STREAM_H__
#define __CHAT_HTTP2_HTTP2_STREAM_H__

#include "frame.h"
#include "chat/mutex.h"
#include <unordered_map>
#include "chat/http/http.h"
#include "chat/blocking_queue.h"
#include "hpack.h"
...
public:
    ...
    int32_t sendResponse(chat::http::HttpResponse::ptr rsp, bool end_stream, bool async);
    int32_t sendRequest(chat::http::HttpRequest::ptr req, bool end_stream, bool async);
...
private:
    ...
    //std::string m_body;
    chat::ds::BlockingQueue<DataFrame> m_data;
