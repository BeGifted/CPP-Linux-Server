#ifndef __CHAT_STREAMS_ASYNC_SOCKET_STREAM_H__
#define __CHAT_STREAMS_ASYNC_SOCKET_STREAM_H__
...
public:
    ...
    void setIOManager(chat::IOManager* v) { m_iomanager = v;}
    chat::IOManager* getIOManager() const { return m_iomanager;}
