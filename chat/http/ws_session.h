#ifndef __CHAT_HTTP_WS_SESSION_H__
#define __CHAT_HTTP_WS_SESSION_H__

#include "chat/config.h"
#include "chat/http/http_session.h"
#include <stdint.h>
...
extern chat::ConfigVar<uint32_t>::ptr g_websocket_message_max_size;
