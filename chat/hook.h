#ifndef __CHAT_HOOK_H__
#define __CHAT_HOOK_H__
...
extern "C" {  //指定这些函数名具有 C 语言链接，这意味着它们应该被视为用 C 语言编写，防止名称修饰。
    typedef unsigned int (*sleep_fun)(unsigned int seconds);  //定义函数指针
    extern sleep_fun sleep_f;  //根据定义时的具体实现而调用相应的休眠函数
