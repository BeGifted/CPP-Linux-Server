...
public:
    ...
    virtual int32_t processStream(chat::grpc::GrpcRequest::ptr request,
                            chat::grpc::GrpcResponse::ptr response,
...
public:
    chat::grpc::GrpcRequest::ptr  getRequest() const { return m_request;}
    chat::grpc::GrpcResponse::ptr getResponse() const { return m_response;}
    chat::grpc::GrpcSession::ptr  getSession() const { return m_session;}
    chat::grpc::GrpcStream::ptr   getStream() const { return m_stream;}
protected:
    GrpcType m_type;
    chat::grpc::GrpcRequest::ptr m_request;
    chat::grpc::GrpcResponse::ptr m_response;
    chat::grpc::GrpcSession::ptr m_session;
    chat::grpc::GrpcStream::ptr m_stream;
};

class CloneServletCreator : public chat::http::IServletCreator {
public:
    ...
    chat::http::Servlet::ptr get() const override {
...
public:
    ...
    typedef std::function<int32_t(chat::grpc::GrpcRequest::ptr request,
                                  chat::grpc::GrpcResponse::ptr response,
                                  chat::grpc::GrpcSession::ptr session)> callback;

    typedef std::function<int32_t(chat::grpc::GrpcRequest::ptr request,
                                  chat::grpc::GrpcResponse::ptr response,
                                  chat::grpc::GrpcStream::ptr stream,
                                  chat::grpc::GrpcSession::ptr session)> stream_callback;

    GrpcFunctionServlet(GrpcType type, callback cb, stream_callback scb);

    int32_t process(chat::grpc::GrpcRequest::ptr request,
                    chat::grpc::GrpcResponse::ptr response,
                    chat::grpc::GrpcSession::ptr session) override;

    int32_t processStream(chat::grpc::GrpcRequest::ptr request,
                    chat::grpc::GrpcResponse::ptr response,
                    chat::grpc::GrpcStream::ptr stream,
                    chat::grpc::GrpcSession::ptr session) override;
...
public:
    ...
    typedef chat::grpc::GrpcServerStreamClient<Req, Rsp> ServerStream;
...
public:
    ...
    typedef chat::grpc::GrpcServerStreamServer<Req, Rsp> ServerStream;
...
public:
    ...
    typedef chat::grpc::GrpcServerStreamBidirection<Req, Rsp> ServerStream;
...
public:
    ...
    typedef chat::grpc::GrpcStreamReader<Req> Reader;
    ...
    virtual int32_t handle(typename Reader::ptr reader, RspPtr rsp,
                           chat::grpc::GrpcRequest::ptr request,
                           chat::grpc::GrpcResponse::ptr response,
                           chat::grpc::GrpcStream::ptr stream,
                           chat::grpc::GrpcSession::ptr session) = 0;
};
...
public:
    ...
    typedef std::shared_ptr<Rsp> RspPtr;
    typedef GrpcStreamServerServlet Base;
    typedef chat::grpc::GrpcStreamWriter<Rsp> Writer;
...
public:
    ...
    typedef chat::grpc::GrpcStreamSession<Req, Rsp> ReaderWriter;
