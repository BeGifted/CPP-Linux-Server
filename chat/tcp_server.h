#ifndef __CHAT_TCP_SERVER_H__
#define __CHAT_TCP_SERVER_H__
...
public:
    ...
    TcpServer(chat::IOManager* worker = chat::IOManager::GetThis()
            ,chat::IOManager* io_woker = chat::IOManager::GetThis()
            ,chat::IOManager* accept_worker = chat::IOManager::GetThis());

    virtual ~TcpServer();

    virtual bool bind(chat::Address::ptr addr, bool ssl = false);
