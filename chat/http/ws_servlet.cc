...
int32_t FunctionWSServlet::onConnect(chat::http::HttpRequest::ptr header
                                     ,chat::http::WSSession::ptr session) {
    if(m_onConnect) {
...
int32_t FunctionWSServlet::onClose(chat::http::HttpRequest::ptr header
                                     ,chat::http::WSSession::ptr session) {
    if(m_onClose) {
...
int32_t FunctionWSServlet::handle(chat::http::HttpRequest::ptr header
