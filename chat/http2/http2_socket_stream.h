#ifndef __CHAT_HTTP2_HTTP2_SOCKET_STREAM_H__
#define __CHAT_HTTP2_HTTP2_SOCKET_STREAM_H__

#include "chat/mutex.h"
#include "chat/streams/async_socket_stream.h"
#include "frame.h"
#include "hpack.h"
...
public:
    ...
    //StreamClient::ptr openStreamClient(chat::http::HttpRequest::ptr request);
    Http2Stream::ptr openStream(chat::http::HttpRequest::ptr request);
